public class MyLinkedList<E>  {
  ...
  public E removeFirst() {
   ...
   public MyLinkedList checkDouble()
   {
       MyLinkedList returnList = new MyLinkedList();
       
       Node<E> ptrList = head;
       Node<E> ptrReturn = returnList.head;
       
       while (ptrList != null)
       {
           while (ptrReturn != null)
           {
               if (!(ptrList.element).equals(ptrReturn.element))
               {
                   returnList.append(ptrList.element);
               }
